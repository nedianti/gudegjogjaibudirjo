...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Perbarui data pengguna dari sesi PHP
            const phpUser = {
                fullname: '<?php echo isset($_SESSION['fullname']) ? $_SESSION['fullname'] : 'Guest'; ?>',
                user_id: '<?php echo isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'null'; ?>'
            };
            localStorage.setItem('user', JSON.stringify(phpUser));
            ...
            document.getElementById('order-form').addEventListener('submit', function(event) {
                ...
                formData.append('order_type', 'online');
                if (paymentProof) {
